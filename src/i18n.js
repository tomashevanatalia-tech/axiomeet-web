...
const DICT = {
  ru: {
    ...
    'auth.forgot.subtitle': 'Укажите email, на который зарегистрирован аккаунт — пришлём ссылку для сброса пароля.',
    'auth.forgot.submit': 'Отправить ссылку',
    'auth.forgot.submitting': 'Отправка...',
    'auth.forgot.success': 'Если email зарегистрирован, письмо со ссылкой отправлено. Проверьте «Входящие» и «Спам».',
